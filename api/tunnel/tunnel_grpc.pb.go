...
const (
	TunnelService_Connect_FullMethodName = "/tunnel.TunnelService/Connect"
)
...
func (c *tunnelServiceClient) Connect(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[TunnelMessage, TunnelMessage], error) {
...
type TunnelService_ConnectClient = grpc.BidiStreamingClient[TunnelMessage, TunnelMessage]
...
func (UnimplementedTunnelServiceServer) Connect(grpc.BidiStreamingServer[TunnelMessage, TunnelMessage]) error {
...
func _TunnelService_Connect_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TunnelServiceServer).Connect(&grpc.GenericServerStream[TunnelMessage, TunnelMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TunnelService_ConnectServer = grpc.BidiStreamingServer[TunnelMessage, TunnelMessage]
